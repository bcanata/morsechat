...
export function AppLogic({ chatDomNode }) {
	...
	function translateToReadable(letter, dialectName) {
		...
		if (dialect.table.hasOwnProperty(letter)) return dialect.table[letter];
		return " " + letter + " ";
	}
	...
	function handleMessage(e) {
		...
		let dialect =
			e.dialect == "international"
				? ""
				: ` [${dialects[e.dialect].short_name}]`;
